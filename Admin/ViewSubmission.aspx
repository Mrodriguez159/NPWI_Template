<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminTemplate.Master" AutoEventWireup="true" CodeBehind="ViewSubmission.aspx.cs" Inherits="LNPWI_DCS.Admin.ViewSubmission" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceholder" runat="server">
    <div class="page-header">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="btn-container">
                <a href="#" class="btn btn-gray mr-1">Reject</a>
                <a href="#" class="btn btn-cherry ">Approve</a>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-8">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <span class="float-right text-muted">Posted on November 10, 2019</span>
                    </div>
                </div>
    ...
    <div class="task-submit collapse" id="view-comments">
        <div class="container">
            <div class="form-group row">
                <label for="addComment" class="col-sm-2 col-form-label"><strong>Add Comment:</strong></label>
                <div class="col-sm-10">
                    <textarea id="comment" class="form-control" cols="40"rows="5" placeholder="Comments..."></textarea>
                </div>
            </div>
            <a href="view-comments" data-toggle="collapse" class="btn btn-gray mr-3">Cancel</a>
